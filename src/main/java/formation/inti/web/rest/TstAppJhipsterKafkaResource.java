...
@RestController
@RequestMapping("/api/tst-app-jhipster-kafka")
public class TstAppJhipsterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TstAppJhipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TstAppJhipsterKafkaResource(KafkaProperties kafkaProperties) {
